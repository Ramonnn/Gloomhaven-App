...
{
    public TestCurrentBosses currentBoss;
    ...
    public void FreshEnemy()
    {
        ...
        maxHealth = currentBoss.monsterHealth * PlayerPrefs.GetInt("NumberOfPlayers");
        remainingHealth = currentBoss.monsterHealth * PlayerPrefs.GetInt("NumberOfPlayers");
